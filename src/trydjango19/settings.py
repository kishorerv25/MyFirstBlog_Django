...
SECRET_KEY = '%gf8zhqet$!h_!$t4y%rpplqjsci7o@zfg*+t4m5st@^5!u%!6'
...
EMAIL_HOST_PASSWORD = 'lokaseva$255'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
#local dir of static files related to project
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),
    # '/var/www/static/',
]

#common server for static files / destination
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "static_cdn")
# user upload files storage
MEDIA_URL = '/media/'
